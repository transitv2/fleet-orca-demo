...
5. **Next.js dashboard rewrite** — keep the operator UX identical; change the substrate. Two sprints.
6. **Merge.dev HRIS connector** — replace the CSV input with real HRIS pulls for one design partner. Three sprints.
